...
|--rpclisten=:9444|all interfaces on port 9444|
|--rpclisten=0.0.0.0:9444|all IPv4 interfaces on port 9444|
|--rpclisten=[::]:9444|all IPv6 interfaces on port 9444|
|--rpclisten=127.0.0.1:9444|only IPv4 localhost on port 9444|
|--rpclisten=[::1]:9444|only IPv6 localhost on port 9444|
...
|--rpclisten=127.0.0.1:8337 --listen=[::1]:9444|IPv4 localhost on port 8337 and IPv6 localhost on port 9444|
|--rpclisten=:9444 --listen=:8337|all interfaces on ports 9444 and 8337|
