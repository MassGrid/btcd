...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/massgrid/btcd/integration/rpctest)
...
```bash
$ go get -u github.com/massgrid/btcd/integration/rpctest
```
