...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/massgrid/btcd/peer)
...
```bash
$ go get -u github.com/massgrid/btcd/peer
```

## Examples

* [New Outbound Peer Example](https://godoc.org/github.com/massgrid/btcd/peer#example-package--NewOutboundPeer)  
