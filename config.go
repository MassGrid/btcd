...
import (
	...
	"github.com/massgrid/btcd/connmgr"
	"github.com/massgrid/btcd/database"
	_ "github.com/massgrid/btcd/database/ffldb"
...
type config struct {
	...
	Listeners            []string      `long:"listen" description:"Add an interface/port to listen for connections (default all interfaces port: 9443, testnet: 19443)"`
	...
	RPCListeners         []string      `long:"rpclisten" description:"Add an interface/port to listen for RPC connections (default port: 9444, testnet: 19444)"`
